...
Route::get('/admin/add_quiz/{type}', 'Admin\QuizController@add_quiz_type');
Route::get('/admin/all_quiz/{type}', 'Admin\QuizController@all_quiz_type');
Route::get('/admin/add_example', 'Admin\QuizController@add_example');
Route::get('/admin/premium','Admin\CheckController@premium');
//Route::get('/admin/store','Admin\CheckController@store');

Route::get('/admin/check/premium', 'Admin\CheckController@check');
//test
//Route::post('/search/the/{name}', 'CheckController@search');
//Route::get('/tfind', 'CheckController@takefind');
//test
...
Route::get('auth/{provider}/callback', 'Auth\LoginController@handleProviderCa
llback');
...
Route::post('/ax_delete_quiz', 'Admin\QuizController@ax_delete_quiz')->name('ax_delete_quiz');
...
Route::post('profile_remove', 'UserController@profile_remove')->name('profile_remove');
