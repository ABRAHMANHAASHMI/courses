    ...
    <form method="POST" id="edit_lesson_form">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="lesson_text[{{$single['id']}}]">{{$single['lesson_text']}}</textarea>
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput">lesson Video</label>
                    <input type="text" class="form-control" id="" placeholder="" name="video_name[{{$single['id']}}]" value="{{$single['lesson_video']}}">
                </div>
