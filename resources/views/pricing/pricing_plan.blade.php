                            ...
                            foreach ($plans as $index => $val){
                                ...
                                <div class="col-md-6">
                                    <div class="plan <?php echo $class;?>">
                                        ...
                                        <div class="plan_body">
                                            <ul>
                                                <li class="active"><p><i class="fa fa-check-circle"></i> <?php echo $val->lesson_count;?> lessons</p></li>
                                                <li><p><i class="fa fa-check-circle"></i> <?php echo $val->typical_task;?> typical tasks</p></li>
                                                <li><p><i class="fa fa-check-circle"></i> <?php echo $val->video_hours; ?> hours video course</p></li>
                                                <li><p><i class="fa fa-check-circle"></i> <?php echo $val->individual_lesson; ?> individual lessons</p></li>
                                            </ul>
                                        </div>
