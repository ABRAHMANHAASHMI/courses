        ...
        <section class="exam_test_head">
            <div class="content">
                ...
                <div class="duration">
                    ...
                    <button type="button" class="start_quiz">START</button>
                </div>
            </div>
        </section>
            ...
            <div class="content">
                <form action="" id="example_form">
                    <div class="row exam_main dis_none">
                        <div class="answer_info col-md-12" id="answer_info"></div>
                        ...
                        @foreach($quizes as $index => $value)
                                        ...
                                        <div class="question">
                                            ...
                                            <ul>
                                                @foreach($value->answer as $answer_index => $answer)
                                                    <li class="example_li">
                                                        <input type="radio" class="check_result_radio" name="result_{{$answer_index+1}}" value="{{$value->id.'->'.$answer->id}}">{{$answer->answer}}{{$answer_index+1}})
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                            ...
                            @else
                                <div class="col-md-6">
                                    <div class="exam_test">
                                        <div class="number_of_exam"><span>{{$index+1}}</span></div>
                                        <div class="question">
                                            <h3>
                                                <img src="{{ asset('quiz_images/'.$value->quiz_name)}}" alt="">
                                            </h3>
                                            <ul>
                                                @foreach($value->answer as $answer_index => $answer)
                                                    <li class="example_li">
                                                        <input type="radio" class="check_result_radio"
                                                               name="result_{{$value->id}}"
                                                               value="{{$value->id.'->'.$answer->id}}">
                        ...
                        {{--    <a href="#" id="loadMore"><i class="material-icons">
                                    keyboard_arrow_down
                                </i></a>--}}
