...
@section('content')
    ...
    <div class="toolbar training_toolbar">
        ...
        <div class="flex_cont_1">
            <div class="go_to">
                <a href="#" class="training_room">Go to training room <i class="fas fa-long-arrow-alt-right"></i></a>
            </div>
            {{--            <div class="logout">
                            <ul>
                                <li>
    ...
    <main>
        ...
        <section class="training_room_content">
            <div class="content">
                        ...
                        <div class="perspective-200">
                            <ul class="list_question">
                                @foreach($value->training_exam as $quiz_index => $quiz_val)
                                    <li><h4><a href="{{url('example/'.$quiz_val->id)}}">PART {{$quiz_index+1}}
                                                <span>({{$quiz_val->count()}} questions with 25 min limit)</span></a>
                                        </h4></li>
                                @endforeach
                            </ul>
                ...
                @endforeach
                <a href="#" id="loadMore"><i class="fa fa-chevron-down"></i></a>
            </div>
        </section>
    </main>
@endsection