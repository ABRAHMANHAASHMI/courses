...
<div id="">
    ...
    @guest
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="content">
                <a class="navbar-brand" href="{{ url('/')}}"><img src="{{ asset('img/logo.png') }}" alt=""><span>Study</span>Courses</a>
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav"
                        aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="footer_logo">
                    ...
                    <ul>
                        <li>
                            <a href="#" class="active"><i class="fa fa-facebook-f"></i></a>
                        </li>
                        <li>
            ...
            <div class="col-md-3">
                <div class="footer_box">
                    <h4>contact us</h4>
                    <ul>
                        <li><p><i class="fa fa-phone"></i>+1 234 567-89-00</p></li>
                        <li><p><i class="fa fa-envelope"></i>abcdff@gmail.com</p></li>
                        <li><p><i class="fa fa-map-marker-alt"></i>Attorney at Law
