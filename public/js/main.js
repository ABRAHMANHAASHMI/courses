...
if (action == 'AppHttpControllersHomeController@index') {
    ...
    function opencourse(evt, courseName, lessonName, tab_lesson) {
        ...
        $('.default_text').addClass('dis_none');
    ...
    function trigered_txt(lessonName) {

        $('#less_' + lessonName).find('#overview').addClass('dis_block');
    }
    ...
    $(document).on('click', '.sort_less', function () {
        ...
        send_ajax(url, 'post', {
            ...
            asc_desc: asc_desc
        }, {answer: '.lessons_sequence_answer'});
    });
}
...
if (action == 'AppHttpControllersHomeController@index') {
    ...
    $(document).on('click', '.check_result', function () {
        ...
        send_ajax(url, 'post', {
            answers: radio_val,
            less_id: $('#less_id').val()
        }, {handler: 'save_quiz_answer_handler'});
    });
